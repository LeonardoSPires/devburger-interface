...
const schema = yup
    .object({
        ...
        }).test('fileSize', 'Carreque arquivos até 5mb', value => {
            return value && value.length > 0 && value[0].size <= 50000;
        }).test('type', 'Carreque apenas arquivos PNG ou JPEG', (value) => {
            return (
                value &&
                value.length > 0 &&
...
export function NewProduct() {
    const [faleName, setFileName] = useState(null);
